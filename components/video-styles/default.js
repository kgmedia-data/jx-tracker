...
const bottomControlsCls     = 'bottomControls' + ran;
...
var stylesStrObj_ = {};
    ...
    stylesStrObj_.newControls = [
        ...
        '.'+overlayControlCls+'{z-index:1;right: 0;left: 0;padding: 10px;position: absolute;bottom: 0;transition: all 0.2s ease;background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.3));}',
        ...
        '.'+overlayControlCls+' button:before{content: attr(data-title);position: absolute;display: none;right: 0;left:unset;top: -50px;background-color: rgba(0, 0, 0, 0.6);color: #fff;padding: 4px 6px;word-break: keep-all;white-space: pre;line-height:1;font-family: Arial, Helvetica, sans-serif;text-transform:none;}',
        '.'+overlayControlCls+' button:hover::before{display: inline-block;}',
        '.'+overlayTitleCls+'{z-index:2;width:100%;padding:10px 40px;position:absolute;top:0;background:rgba(0, 0, 0, 0.2);}',
        '.'+overlayTitleCls+' div{overflow:hidden;width:85%;font-size:14px;color:#fff;text-align:left;font-family: Arial, Helvetica, sans-serif;font-weight:600;display: -webkit-box;-webkit-line-clamp: 1;-webkit-box-orient: vertical;}',
        '.'+fullscreenBtnCls+', .'+fullscreenExitBtnCls+', .'+settingBtnCls+'{font-family: JXVideo;line-height:1;font-size: 2.75em;color: #fff;font-style: normal;}',
        '.'+fullscreenBtnCls+':before{content: "\\f108";}',
        '.'+fullscreenExitBtnCls+':before{content: "\\f109";}',
        '.'+settingBtnCls+':before{content: "\\f110";}',
        '.'+pauseBtnCls+', .'+playBtnCls+'{font-family: JXVideo;line-height:1;font-size: 2.75em;color: #fff;font-style: normal;}',
        '.'+pauseBtnCls+':before, .'+overlayBigPauseBtnCls+':before{content: "\\f103";}',
        '.'+volumeLowCls+', .'+volumeMidCls+', .'+volumeHighCls+', .'+muteBtnCls+'{font-family: JXVideo;line-height:1;font-size: 2.75em;color: #fff;font-style: normal;}',
        ...
        '.'+overlayBigPauseBtnCls+', .'+overlayBigPlayBtnCls+'{font-family: JXVideo;line-height:1;font-size: 2.75em;color: #fff;font-style: normal;}',
        '.'+playBtnCls+':before, .'+overlayBigPlayBtnCls+':before{content: "\\f101";}',
        '.'+overlayBigPlayBtnCls+', .'+overlayBigPauseBtnCls+'{font-size:5.25em}',
        '.'+leftControlsCls+', .'+rightControlsCls+', .'+bottomControlsCls+'{display:flex;justify-content:center;align-items:center;color:#fff;}',
        '.'+bottomControlsCls+'{margin-top:5px;justify-content:space-between;}',
        '.'+speedValueCls+'{width: auto;height: auto;display: flex;justify-content: center;align-items: center;color: #fff;font-size: 2em;background: #ffffff5e;border-radius: 5px;padding: 3px;font-weight:700;line-height:1;text-transform:none;font-family: Arial, Helvetica, sans-serif;}',
        '.'+volumeControlCls+'{display:flex;align-items:center;margin-right:10px;}',
        'input[type="range"].'+volumePanelCls+'{-webkit-appearance: none;width: 70px;height: 5px;background: rgba(255, 255, 255, 1);border-radius: 5px;background-image: linear-gradient(#1B63D4, #1B63D4);background-size: 100% 100%;background-repeat: no-repeat;}',
        'input[type="range"].'+volumePanelCls+'::-webkit-slider-thumb, input[type="range"].'+volumePanelCls+'::-moz-range-thumb, input[type="range"].'+volumePanelCls+'::-ms-thumb{-webkit-appearance: none;height: 17px;width: 17px;border-radius: 50%;background: #fff;'+
            'cursor: ew-resize;box-shadow: 0 0 2px 0 #555;transition: background .3s ease-in-out;}',
        '.'+speedSelectionCls+', .'+qualitySelectionCls+'{width: 50px;position: absolute;bottom: 85px;left: 50%;right: 50%;transform: translate(-50%, 0);}',
        '.'+qualitySelectionCls+'{width:80px;}',
        '.'+speedSelectionCls+' div, .'+qualitySelectionCls+' div{background-color: #fff;color: #000;text-align: center;padding: 5px;font-family: Arial, Helvetica, sans-serif;font-size:12px;cursor: pointer;}',
        '.'+speedSelectionCls+' div:hover, .'+speedSelectionCls+' .active, .'+qualitySelectionCls+' .'+qualityItemsCls+':hover, .'+qualitySelectionCls+' .'+qualityItemsCls+'.active{font-weight: bold;background-color: #66B4F4;}',
        '.'+speedContainerCls+'{position: relative;display: flex;justify-content: center;align-items: center;margin-right: 7px;}',
        '.'+playbackAnimationCls+'{cursor:pointer;position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);z-index:2;opacity:1;}',
...
function getCls_() {
    return {
        ...
        bottomControlsCls:      bottomControlsCls,
