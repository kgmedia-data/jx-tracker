...
var buttonsColor = '%%buttonsColor%%';
    ...
    stylesStrObj_.newControls = [
        ...
        '.'+overlayControlCls+'{display: flex;flex-direction: column;z-index:1;right: 0;left: 0;padding: 10px;position: absolute;bottom: 0;transition: all 0.2s ease;background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.3));}',
        ...
        '.'+overlayTitleCls+' div{overflow:hidden;width:85%;font-size:14px;color:'+buttonsColor+';text-align:left;font-family: Arial, Helvetica, sans-serif;font-weight:600;display: -webkit-box;-webkit-line-clamp: 1;-webkit-box-orient: vertical;}',
        '.'+fullscreenBtnCls+', .'+fullscreenExitBtnCls+', .'+settingBtnCls+'{font-family: JXVideo;line-height:1;font-size: 2.75em;color: '+buttonsColor+';font-style: normal;}',
        '.'+fullscreenBtnCls+':before{content: "\\f108";}',
        '.'+fullscreenExitBtnCls+':before{content: "\\f109";}',
        '.'+settingBtnCls+':before{content: "\\f110";}',
        '.'+pauseBtnCls+', .'+playBtnCls+'{font-family: JXVideo;line-height:1;font-size: 2.75em;color: '+buttonsColor+';font-style: normal;}',
        '.'+pauseBtnCls+':before, .'+overlayBigPauseBtnCls+':before{content: "\\f103";}',
        '.'+volumeLowCls+', .'+volumeMidCls+', .'+volumeHighCls+', .'+muteBtnCls+'{font-family: JXVideo;line-height:1;font-size: 2.75em;color: '+buttonsColor+';font-style: normal;}',
        ...
        '.'+overlayBigPauseBtnCls+', .'+overlayBigPlayBtnCls+'{font-family: JXVideo;line-height:1;font-size: 2.75em;color: '+buttonsColor+';font-style: normal;}',
        ...
        '.'+speedContainerCls+', .'+subtitleContainerCls+'{position: relative;display: flex;justify-content: center;align-items: center;margin-right: 7px;}',
        ...
        '.'+playbackAnimationCls+', .'+playbackRoundedCls+'{cursor:pointer;position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);z-index:2;opacity:1;}',
