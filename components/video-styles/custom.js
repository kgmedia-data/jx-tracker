...
var buttonsColor = '%%buttonsColor%%';
  ...
  stylesStrObj_.customControls = [
    ...
    '.'+css_.leftCtrl+',.'+css_.rightCtrl+',.'+css_.botCtrl+'{display:flex;align-items:center;color:'+buttonsColor+';}',
    ...
    '.'+css_.speedMenu+',.'+css_.resMenu+',.'+css_.capMenu+'{width:50px;position:absolute;bottom:30px;left:50%;right:50%;transform:translate(-50%, 0);z-index:2;}',
    ...
    '.'+css_.roundBigPlayBtnCtr+'{width:4.5em;height:4.5em;position:relative;border-radius:100%;background:'+primaryColor+';}',
