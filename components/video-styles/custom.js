...
var buttonsColor = '%%buttonsColor%%';
  ...
  stylesStrObj_.customControls = [
    ...
    '.'+css_.oBotCtrl+' button:before{font-size:11px;content:attr(data-title);position:absolute;display:none;right:0;left:unset;top:-50px;background-color:rgba(0, 0, 0, 0.6);color:#fff;padding:4px 6px;word-break:keep-all;white-space:pre;line-height:1;font-family:"Roboto", sans-serif;text-transform:none;}',
    ...
    '.'+css_.oTitle+' div{overflow:hidden;width:80%;font-size:14px;color:'+buttonsColor+';text-align:left;font-family:"Roboto", sans-serif;font-weight:600;display:-webkit-box;-webkit-line-clamp:1;-webkit-box-orient:vertical;text-shadow:1px 1px 1px rgb(0 0 0 / 80%);}',
    ...
    '.'+css_.speedVal+',.'+css_.capVal+'{width:auto;height:auto;display:flex;justify-content:center;align-items:center;color:'+buttonsColor+';font-size:14px;background: #ffffff5e;border-radius: 5px;padding: 6px;font-weight:700;line-height:1;text-transform:none;font-family: "Roboto", sans-serif;letter-spacing:normal;}',
    ...
    '.'+css_.speedMenu+' div, .'+css_.resMenu+' div, .'+css_.capMenu+' div{background-color:'+buttonsColor+';color:#000;text-align:center;padding:5px;font-family:"Roboto", sans-serif;font-size:12px;cursor:pointer;}',
