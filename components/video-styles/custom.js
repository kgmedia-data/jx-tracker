...
function makeStyles_(css_) {
  ...
  stylesStrObj_.customControls = [
    ...
    '.'+css_.oBotCtrl+' button span, .'+css_.custBigPauseBtn+',.'+css_.custBigPlayBtn+'{font:18px/1 JXVideo;color:'+buttonsColor+';width:100%;height:100%;}',
    '.'+css_.oBotCtrl+' button:before{content:attr(data-title);position:absolute;display:none;right:0;left:unset;top:-35px;background-color:rgba(0, 0, 0, 0.6);color:#fff;padding:4px 6px;word-break:keep-all;white-space:pre;font: 10px/1 Roboto;text-transform:none;}',
    ...
    '.'+css_.oTitle+' div{font:600 14px/1 Roboto;overflow:hidden;width:80%;color:'+buttonsColor+';text-align:left;display:-webkit-box;-webkit-line-clamp:1;-webkit-box-orient:vertical;text-shadow:1px 1px 1px rgb(0 0 0 / 80%);}',
    ...
    '.'+css_.botCtrl+' *{display:flex;align-items:center;color:'+buttonsColor+';}',
    '.'+css_.botCtrl+'{width:100%;justify-content:space-between;order:2;display:flex}',
    '.'+css_.speedVal+',.'+css_.capVal+'{width:auto;height:auto;display:flex;justify-content:center;align-items:center;color:'+buttonsColor+';background: #ffffff5e;border-radius:2px;padding:3.5px;line-height:1;text-transform:none;font:normal normal bold 10px/11px Roboto !important;letter-spacing:normal;}',
    ...
    '.'+css_.speedMenu+' div, .'+css_.resMenu+' div, .'+css_.capMenu+' div{background-color:'+buttonsColor+';color:#000;width:100%;justify-content:center;padding:5px;cursor:pointer;font:12px/1 Roboto}',
    ...
    '.'+css_.vidProgTooltip+'{display:none;position:absolute;top:-30px;margin-left:-20px;font-size:10px;padding:3px;content:attr(data-title);font-weight:bold;color:#fff;background-color:rgba(0, 0, 0, 0.6);}',
