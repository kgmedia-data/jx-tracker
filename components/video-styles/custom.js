...
function makeCssCustomControls_(css_, o) {
  return [
    ...
    '.'+css_.oHotspot+'.top-right{top:0;right:0;}',
    '.'+css_.oHotspot+'.top-left{top:0;left:0;}',
    '.'+css_.oHotspot+'.top-center{top:0;left:50%;transform:translate(-50%,0);}',
    '.'+css_.oHotspot+'.bottom-right{bottom:0;right:0;}',
    '.'+css_.oHotspot+'.bottom-left{bottom:0;left:0;}',
    '.'+css_.oHotspot+'.bottom-center{bottom:0;left:50%;transform:translate(-50%,0);}',
  ].join("\n");
}
