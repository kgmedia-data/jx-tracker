...
var buttonsColor = '%%buttonsColor%%';
  ...
  stylesStrObj_.customControls = [
    ...
    '.'+overlayControlCls+'{display: flex;flex-direction: column;z-index:3;right: 0;left: 0;padding: 10px;position: absolute;bottom: 0;transition: all 0.2s ease;background:linear-gradient(180deg,transparent,rgba(0,0,0,.8) 80%);}',
    '.'+overlayControlCls+' button{display:flex;position:relative;align-items:center;justify-content:center;border:none;outline:none;background-color:transparent;padding:3px;box-shadow:none;-moz-appearance: none;-webkit-appearance: none;-ms-appearance: none;appearance: none;cursor:pointer;}',
    ...
    '.'+fullscreenBtnCls+', .'+fullscreenExitBtnCls+', .'+settingBtnCls+'{font-family: JXVideo;line-height:1;font-size: 28px;font-weight:bold;color: '+buttonsColor+';font-style: normal;}',
    '.'+fullscreenBtnCls+':before{content: "\\f108";}',
    '.'+fullscreenExitBtnCls+':before{content: "\\f109";}',
    '.'+settingBtnCls+':before{content: "\\f110";}',
    '.'+pauseBtnCls+', .'+playBtnCls+'{font-family: JXVideo;line-height:1;font-size: 28px;font-weight:bold;color: '+buttonsColor+';font-style: normal;}',
    '.'+pauseBtnCls+':before, .'+overlayBigPauseBtnCls+':before{content: "\\f103";}',
    '.'+volumeLowCls+', .'+volumeMidCls+', .'+volumeHighCls+', .'+muteBtnCls+'{font-family: JXVideo;line-height:1;font-size: 28px;font-weight:bold;color: '+buttonsColor+';font-style: normal;}',
    ...
    '.'+overlayBigPauseBtnCls+', .'+overlayBigPlayBtnCls+'{font-family: JXVideo;line-height:1;font-size: 28px;font-weight:bold;color: '+buttonsColor+';font-style: normal;}',
    '.'+playBtnCls+':before, .'+overlayBigPlayBtnCls+':before{content: "\\f101";}',
    '.'+overlayBigPlayBtnCls+', .'+overlayBigPauseBtnCls+'{font-size:6em}',
    ...
    '.'+speedValueCls+', .'+subtitleValueCls+'{width: auto;height: auto;display: flex;justify-content: center;align-items: center;color: '+buttonsColor+';font-size: 18px;background: #ffffff5e;border-radius: 5px;padding: 3px;font-weight:700;line-height:1;text-transform:none;font-family: Arial, Helvetica, sans-serif;letter-spacing:normal;}',
    '.'+volumeControlCls+'{display:flex;align-items:center;margin-right:10px;}',
    'input[type="range"].'+volumePanelCls+'{-webkit-appearance: none;width: 70px;height: 5px;background: rgba(255, 255, 255, 1);border-radius: 5px;background-image: linear-gradient('+primaryColor+', '+primaryColor+');background-size: 100% 100%;background-repeat: no-repeat;-webkit-tap-highlight-color: transparent;cursor:ew-resize;}',
    ...
    '.'+speedSelectionCls+', .'+qualitySelectionCls+', .'+subtitleSelectionCls+'{width: 50px;position: absolute;bottom: 30px;left: 50%;right: 50%;transform: translate(-50%, 0);z-index:9999;}',
    ...
    '.'+playbackAnimationCls+', .'+playbackRoundedCls+'{font-size:14px;cursor:pointer;opacity:1;order:2;display:flex;align-items:center;}',
    ...
    '.'+fastForwardBtnContainerCls+' span, .'+backwardBtnContainerCls+' span{position:absolute;color:'+buttonsColor+';font-size:14px;top:55%;left:50%;transform:translate(-50%, -50%)}',
  ].join("\n");
