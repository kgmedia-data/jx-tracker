...
function makeStyles_(css_) {
  ...
  stylesStrObj_.customControls = [
    ...
    '.'+css_.oBotCtrl+'{display:flex;flex-direction:column;z-index:3;right:0;left:0;padding:5px 10px;position:absolute;bottom:0;transition:all 0.2s ease;background:linear-gradient(180deg,transparent,rgba(0,0,0,.8) 80%);}',
    '.'+css_.oBotCtrl+' button{display:flex;position:relative;align-items:center;justify-content:center;border:none;outline:none;background-color:transparent;padding:0;width:18px;height:18px;box-shadow:none;-moz-appearance: none;-webkit-appearance: none;-ms-appearance: none;appearance: none;cursor:pointer;}',
    '.'+css_.oBotCtrl+' button:before{font-size:10px;content:attr(data-title);position:absolute;display:none;right:0;left:unset;top:-50px;background-color:rgba(0, 0, 0, 0.6);color:#fff;padding:4px 6px;word-break:keep-all;white-space:pre;line-height:1;font-family:"Roboto", sans-serif;text-transform:none;}',
    ...
    '.'+css_.fsBtn+',.'+css_.fsExitBtn+',.'+css_.resBtn+'{font-family:JXVideo;line-height:1;font-size:18px;color:'+buttonsColor+';width:100%;height:100%;}',
    '.'+css_.fsBtn+':before{content:"\\f108";}',
    '.'+css_.fsExitBtn+':before{content:"\\f109";}',
    '.'+css_.resBtn+':before{content:"\\f110";}',
    '.'+css_.pauseBtn+',.'+css_.playBtn+'{font-family:JXVideo;line-height:1;font-size:18px;color:'+buttonsColor+';margin-right:7px;width:100%;height:100%;}',
    '.'+css_.pauseBtn+':before, .'+css_.custBigPauseBtn+':before{content:"\\f103";}',
    '.'+css_.volLow+',.'+css_.volMid+',.'+css_.volHigh+',.'+css_.muteBtn+'{font-family:JXVideo;line-height:1;font-size:18px;color:'+buttonsColor+';width:100%;height:100%;}',
    ...
    '.'+css_.custBigPauseBtn+',.'+css_.custBigPlayBtn+'{font-family:JXVideo;line-height:1;font-size:28px;color:'+buttonsColor+';}',
    ...
    '.'+css_.speedVal+',.'+css_.capVal+'{width:auto;height:auto;display:flex;justify-content:center;align-items:center;color:'+buttonsColor+';background: #ffffff5e;border-radius:2px;padding:3.5px;line-height:1;text-transform:none;font:normal normal bold 10px/11px Roboto;letter-spacing:normal;}',
    '.'+css_.volCtrl+'{display:flex;align-items:center;margin-right:10px;}',
    'input[type="range"].'+css_.volPanel+'{-webkit-appearance:none;width:70px;height:3px;background:rgba(255, 255, 255, 1);border-radius:3px;background-image:linear-gradient('+primaryColor+', '+primaryColor+');background-size:100% 100%;background-repeat:no-repeat;-webkit-tap-highlight-color:transparent;cursor:ew-resize;}',
    ...
    '.'+css_.vidProgCtr+'{display:flex;flex-direction:column;height:3px;width:100%;position:relative;margin-bottom:3px;}',
    ...
    '.'+css_.vidProgTooltip+'{display:none;position:absolute;top:-50px;margin-left:-20px;font-size:10px;padding:3px;content:attr(data-title);font-weight:bold;color:#fff;background-color:rgba(0, 0, 0, 0.6);}',
    ...
    '.'+css_.ffwrdBtnCtr+' span, .'+css_.bwrdBtnCtr+' span{position:absolute;color:'+buttonsColor+';font-size:10px;top:55%;left:50%;transform:translate(-50%, -50%)}',
    '.'+css_.timeDispCtr+' span{font:normal normal normal 12px/14px Roboto;}'
  ].join("\n");
