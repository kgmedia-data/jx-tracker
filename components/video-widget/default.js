...
function makeCssDefault_(css_) {
  return [
    ...
    `.${css_.carouselBtn} {width:40px;height:40px;top:50%;border:1px solid #e5e5e5;position:absolute;z-index:2;border-radius: 35px;background:#fff;display:flex;justify-content:center;align-items:center;transition: all .2s ease;font-family:Roboto, sans-serif;transform:translate(0px, -50%);}`,
    ...
    `.${css_.closeBtn}{position:absolute;cursor:pointer;top:4px;right:4px;z-index:3;appearance:none;border:1px solid transparent;width:30px;height:30px;background:transparent;display:flex;justify-content:center;align-items:center;padding:0;}`,
