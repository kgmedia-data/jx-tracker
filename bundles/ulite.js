 ...
 * 
 * it also will try to replace the old jxfriendly 3.1 
 */

 DO_NOT_REMOVE_GULPBUILD_REPLACE_FLOAT_COND_COMPILE

 if (JX_FLOAT_COND_COMPILE) {
    // the latter one is because we use whatever is generated here to replace
    // jxfriendly.3.1 
     if (window.jxuniv || window.jxuniversal) {
         return;
     }
